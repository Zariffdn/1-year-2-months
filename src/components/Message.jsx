...
function Message() {
  ...
  const pictures = [
    ...
    { Image: picture, title: '', description: " Looking back at these months, through every laugh, every moment of growth, and even the times we stumbled, my heart keeps choosing you, over and over again. Snow Mahal have made my days brighter, my nights warmer, and my world infinitely better just by being in ittt."},
